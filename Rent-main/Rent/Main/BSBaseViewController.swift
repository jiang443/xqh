...
public class BSBaseViewController: BaseViewController {
    ...
    public func mj_refreshHeader(action: Selector) -> MJRefreshNormalHeader {
    ...
    public func mj_refreshFooter(action: Selector) -> MJRefreshAutoNormalFooter {
