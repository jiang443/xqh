...
class MineItemCell: UICollectionViewCell {
    ...
    var dict: Dictionary<String, Any> = [:] {
        didSet {
            self.titleLabel.text = dict.stringValue(key: "title")
            self.iconImageView.image = UIImage(named: dict.stringValue(key: "icon"))
        }
    }
}
