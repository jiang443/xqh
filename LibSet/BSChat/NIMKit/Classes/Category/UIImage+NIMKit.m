...
//        NSString *path = [imageBundle pathForResource:[NSString stringWithFormat:@"%@@2x",imageName] ofType:@"png"];
//        image = [UIImage imageWithContentsOfFile:path];
        image = [UIImage imageNamed:imageName inBundle:imageBundle compatibleWithTraitCollection:nil];
    }
...
+ (UIImage *)nim_emoticonInKit:(NSString *)imageName
{
    ...
    if (image == nil){
        NSBundle *bundle = [NSBundle bundleForClass:[NIMKit class]];
        NSURL *url = [bundle URLForResource:[[NIMKit sharedKit] emoticonBundleName] withExtension:nil];
        NSBundle *imageBundle = [NSBundle bundleWithURL:url];
        //        NSString *path = [imageBundle pathForResource:[NSString stringWithFormat:@"%@@2x",imageName] ofType:@"png"];
        //        image = [UIImage imageWithContentsOfFile:path];
        image = [UIImage imageNamed:imageName inBundle:imageBundle compatibleWithTraitCollection:nil];
