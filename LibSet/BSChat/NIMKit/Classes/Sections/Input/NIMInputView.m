...
- (void)setup
{
    ...
    //NIM::added by jiang,语音输入时被系统事件中断
    [_toolBar.recordButton addTarget:self action:@selector(onTouchRecordBtnUpInside:) forControlEvents:UIControlEventTouchCancel];
