//
//  ComDirectorChatListViewController.swift
//  Alamofire
//
...
class ComDirectorChatListViewController: BaseChatListViewController{
    ...
    override func getHeaderView() -> UIView{
        ...
        researchPlanCell.nameLabel.text = "随访方案审核"
        ...
        assistCell.frame = CGRect(x: 0, y: cellHeight*1, width: rect.width, height: cellHeight)
