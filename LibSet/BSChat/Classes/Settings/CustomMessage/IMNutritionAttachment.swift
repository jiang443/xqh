...
class IMNutritionAttachment: NSObject,NIMCustomAttachment,IMCustomAttachmentInfo {
...
//    var model = RecipeModel()
    ...
    func cellContent(_ message:NIMMessage?) -> String{
        return "BSChat.IMNutritionContentView"
    }
...
//        var dict = [String:Any]()
//        var data = [String:Any]()
//        dict[EncodeKeys.CMType] = IMCustomMessageType.nutrition.rawValue
