...
public class UIUtils:NSObject {
    ...
    public class func getThemeColor() -> UIColor{
    ...
    public class func getLineGrayColor() -> UIColor{
        return  colorWithHexString("#DCDCDC")
    }
    
    public class func getTextColor()->UIColor{
        return colorWithHexString("#5E5E5E")
    }
    
    public class func getLineBackgroundColor()->UIColor{
        return colorWithHexString("#EEEEEE")
    }
    
    public class func getRedColor() -> UIColor{
        return  colorWithHexString("#FC5253")
    }
    
    public class func getGreenColor() -> UIColor{
        return UIColor.color(hex: "#33cc66")   //00CC66
    }
    
    public class func getDarkGreenColor() -> UIColor{
        return colorWithHexString("#01b18a")
    }
    
    public class func getLightBlueColor() -> UIColor{
        return colorWithHexString("#35AAED")
    }
    
    public class func getBlueColor() -> UIColor{
        return colorWithHexString("#2589C2")
        //UIUtils.colorWithHexString("0066ff"))
    }
    
    public class func getTextBlueColor() -> UIColor{
        return colorWithHexString("#0066ff")
    }
    
    public class func getOrangeColor() -> UIColor{
        return colorWithHexString("#F8B551")
    }

    public class func getBlackColor() -> UIColor{
        return colorWithHexString("#2e2d32")
    }
    
    public class func getDoctorBlue() -> UIColor{
        return colorWithHexString("#5b88f3")
    }
    
    public class func getBlueBackground() -> UIColor{
        return colorWithHexString("#f5f8fe")
    }
    
    public class func getIconBackColor() -> UIColor{
        return colorWithHexString("#f7faff")
    }
    
    
    public class func getScreenWidth()->CGFloat{
        return  UIScreen.main.bounds.width
    }
    
    public class func getScreenHeight()->CGFloat{
        return  UIScreen.main.bounds.height
    ...
    * 默认图片
    */
    public class func getDefautImage() -> UIImage{
    ...
    public class func getHighlightColor() -> UIColor{
    ...
    /**
     虚线框
     */
    public class func drawDashRect(_ view:UIView,cornerRadius:CGFloat){
        ...
        border.lineCap = CAShapeLayerLineCap.square
     ...
     *  获取字符串的宽度和高度
     */
    public class func getTextRectSize(_ text:NSString,font:UIFont,width:CGFloat) -> CGRect {
    ...
    /**
     获取文本文件内容
     */
    public class func getTextFile(_ name:String,type:String) -> String{
        let path = Bundle.main.path(forResource: name, ofType: type)
        let content = try! NSString(contentsOfFile: path!, encoding: String.Encoding.utf8.rawValue)
        return content as String
    }
    
    public class func writeFile(_ content:String, fileName:String) -> Bool{
...
//        }
    ...
    public class func readdFile(_ fileName:String) -> String{
//        let path = NSBundle.mainBundle().pathForResource(name, ofType: type)
//        if path == nil || path!.isEmpty{
//            return ""
//        }
    ...
    public class func getFilePath() -> String{
    ...
    public class func setLabel(_ label:UILabel){
    ...
    public class func getCurrentVC() -> UIViewController? {
        if let rootViewController = UIUtils.getAppDelegate()?.window??.rootViewController{
    ...
    public class func getCurrentVCFrom(_ rootVC: UIViewController) -> UIViewController? {
     ...
     */
    public class func showBadgeOnItmIndex(_ tabBar:UITabBar, index: Int, itemCount: Int) {
     ...
     */
    public class func hideBadgeOnItemIndex(_ tabBar:UITabBar, index: Int) {
     ...
     */
    public class func removeBadgeOnItemIndex(_ tabBar:UITabBar, index: Int) {
    ...
    /**
     给视图添加Touch手势方法
     */
    public class func addSelector(_ view:UIView, action: Selector){
    ...
    public class func addCancelActionTarget(_ alertController: UIAlertController, title: String) {
    ...
    public class func addActionTarget(_ alertController: UIAlertController, title: String, color: UIColor, action actionTarget: @escaping (_ action: UIAlertAction) -> Void) {
    ...
    public class func getFlowLayout(lineItemsCount:CGFloat, bodyWdith:CGFloat) -> UICollectionViewFlowLayout{
    ...
    public class func getFlowLayout(lineItemsCount:CGFloat, bodyWdith:CGFloat, itemHeight:CGFloat) -> UICollectionViewFlowLayout{
        let itemWidth = CGFloat(bodyWdith) / lineItemsCount
        let flowLayout = UICollectionViewFlowLayout()
    ...
    ///底部控制栏高度
    public class func getBottomViewHeight() -> CGFloat{
    ...
    public class func getTabBarHeight() -> CGFloat{
        ...
        if let height = UIUtils.getCurrentVC()?.tabBarController?.tabBar.frame.height{
            barHeight = height
        }
        return barHeight
    }
    
    public class func getTopHeight() -> CGFloat{
